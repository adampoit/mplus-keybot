...
internal sealed class StubBlizzardState
{
    ...
    {
        lock (m_lock)
            m_characters = characters.ToList();
    }
    ...
    private IReadOnlyList<BlizzardCharacterDto> GetCharacters()
    {
        lock (m_lock)
...
internal sealed class AnnouncementCollector
{
    ...
    public IReadOnlyList<WebhookAnnouncement> GetAll() => m_announcements.ToList();
